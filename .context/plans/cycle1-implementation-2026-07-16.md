...
- Status: Ready; implement with P06 so the check targets the final worker architecture.
...
- Status: Ready locally. Adding a CI lane remains blocked by P28.
...
- Status: Ready. If a bundler is added, use the current stable registry release verified at implementation time.
...
- Status: Ready after P10 behavior is pinned.
