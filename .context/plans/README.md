...
## Active
- `cycle6-implementation-2026-07-24.md` — Planned remediation for 4 fresh findings covering empty-track GPX route fallback, obsolete wrapped-geometry retention, scene-preview lifecycle settlement, and semantic scene no-op export preservation; no deployment is permitted
