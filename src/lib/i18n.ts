...
export const translations = {
  en: {
    ...
    'fileUpload.importGuideLink': 'How to get your travel data',
    ...
    'camera.orbitDesc': 'Circle around a point',
    'camera.groundDesc': 'Street-level chase view',
  ...
  ko: {
    ...
    'camera.orbitDesc': '한 지점을 중심으로 회전',
    'camera.groundDesc': '거리 수준의 추적 시점',
