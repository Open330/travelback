...
export const translations = {
  en: {
    ...
    'app.exportSaveFailed': 'The video is ready, but it could not be saved to the selected file. Use Download Video to try again.',
  ...
  ko: {
    ...
    'app.exportSaveFailed': '영상은 준비되었지만 선택한 파일에 저장하지 못했습니다. 영상 다운로드를 눌러 다시 시도해 주세요.',
  ...
  ja: {
    ...
    'app.exportSaveFailed': '動画の準備はできましたが、選択したファイルに保存できませんでした。「動画をダウンロード」でもう一度お試しください。',
  ...
  zh: {
    ...
    'app.exportSaveFailed': '视频已生成，但无法保存到所选文件。请点击“下载视频”重试。',
  ...
  es: {
    ...
    'app.exportSaveFailed': 'El video está listo, pero no se pudo guardar en el archivo elegido. Usa Descargar video para volver a intentarlo.',
