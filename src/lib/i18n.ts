...
export const translations = {
  en: {
    ...
    'fileUpload.recoveryHint': 'Use an extracted .json Timeline export, .gpx, or .kml file. ZIP files must be extracted first.',
  ...
  ko: {
    ...
    'fileUpload.recoveryHint': '압축을 푼 .json 타임라인 내보내기, .gpx, .kml 파일을 사용하세요. ZIP 파일은 먼저 압축을 풀어야 합니다.',
  ...
  ja: {
    ...
    'fileUpload.recoveryHint': '展開済みの .json タイムラインエクスポート、.gpx、または .kml ファイルを使ってください。ZIP ファイルは先に展開してください。',
  ...
  zh: {
    ...
    'fileUpload.recoveryHint': '请使用已解压的 .json 时间轴导出、.gpx 或 .kml 文件。ZIP 文件必须先解压。',
  ...
  es: {
    ...
    'fileUpload.recoveryHint': 'Usa un archivo .json de cronología extraído, .gpx o .kml. Los archivos ZIP deben extraerse primero.',
