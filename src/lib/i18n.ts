...
export const translations = {
  en: {
    ...
    'fileUpload.formatHint': 'Tip: current Google Timeline exports come from your phone. Legacy Takeout ZIPs may still contain compatible JSON. Photos and videos are not route files.',
  ...
  ko: {
    ...
    'fileUpload.formatHint': '도움말: 현재 Google 타임라인 데이터는 휴대폰에서 내보냅니다. 기존 Takeout ZIP에도 호환되는 JSON이 있을 수 있습니다. 사진과 동영상은 경로 파일이 아닙니다.',
  ...
  ja: {
    ...
    'fileUpload.formatHint': 'ヒント: 現在の Google タイムラインはスマートフォンから書き出します。従来の Takeout ZIP に互換 JSON が含まれる場合もあります。写真や動画はルートファイルではありません。',
  ...
  zh: {
    ...
    'fileUpload.formatHint': '提示：当前 Google 时间线数据需从手机导出。旧版 Takeout ZIP 中也可能包含兼容的 JSON。照片和视频不是路线文件。',
  ...
  es: {
    ...
    'fileUpload.formatHint': 'Consejo: las exportaciones actuales de Google Timeline se hacen desde el teléfono. Los ZIP antiguos de Takeout aún pueden contener JSON compatible. Las fotos y los videos no son archivos de ruta.',
