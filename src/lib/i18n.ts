...
export const translations = {
  en: {
    ...
    'export.at': 'at',
    'export.estimatedTime': 'Approx. estimated time:',
    ...
    'export.readyDescription': 'Your video is ready. Use the preview, share button, or export again if you still need a local copy.',
  ...
  ko: {
    ...
    'export.readyDescription': '영상이 준비되었습니다. 미리보기, 공유 버튼을 사용하거나 로컬 사본이 필요하면 다시 내보내세요.',
  ...
  ja: {
    ...
    'export.readyDescription': '動画の準備ができました。プレビューや共有ボタンを使うか、ローカルコピーが必要な場合はもう一度エクスポートしてください。',
  ...
  zh: {
    ...
    'export.ready': '视频已准备好',
    'export.readyDescription': '视频已准备好。可使用预览、分享按钮，或在仍需要本地副本时再次导出。',
  ...
  es: {
    ...
    'export.at': 'a',
    'export.estimatedTime': 'Tiempo aprox. estimado:',
    ...
    'export.readyDescription': 'Tu video está listo. Usa la vista previa, el botón de compartir o exporta de nuevo si aún necesitas una copia local.',
