...
export const translations = {
  en: {
    ...
    'journey.searchPlaceholder': 'Paste coordinates or map link',
    'journey.searchAction': 'Go',
    'journey.searchPrivacy': 'Paste coordinates like 37.5665, 126.9780, geo:37.5665,126.9780, or a map link. This stays local.',
    'journey.searchEnableTitle': 'Jump to coordinates',
    'journey.searchEnableAction': 'Open tool',
    'journey.searchDisableAction': 'Hide',
    'journey.searchDisabledPrivacy': 'Open a local-only jump tool to center the map from pasted coordinates or map links. No network request is sent.',
    'journey.searchInvalid': 'Could not read that location. Paste coordinates like 37.5665, 126.9780 or a supported map link.',
  ...
  ko: {
    ...
    'journey.searchPlaceholder': '좌표 또는 지도 링크 붙여넣기',
    'journey.searchAction': '이동',
    'journey.searchPrivacy': '37.5665, 126.9780, geo:37.5665,126.9780 같은 좌표나 지도 링크를 붙여넣으세요. 이 작업은 로컬에서만 처리됩니다.',
    'journey.searchEnableTitle': '좌표로 이동',
    'journey.searchEnableAction': '도구 열기',
    'journey.searchDisableAction': '숨기기',
    'journey.searchDisabledPrivacy': '붙여넣은 좌표나 지도 링크로 지도를 이동하는 로컬 전용 도구입니다. 네트워크 요청은 보내지 않습니다.',
    'journey.searchInvalid': '위치를 해석할 수 없습니다. 37.5665, 126.9780 같은 좌표나 지원되는 지도 링크를 붙여넣으세요.',
  ...
  ja: {
    ...
    'journey.searchPlaceholder': '座標または地図リンクを貼り付け',
    'journey.searchAction': '移動',
    'journey.searchPrivacy': '37.5665, 126.9780 や geo:37.5665,126.9780 のような座標、または地図リンクを貼り付けてください。処理はローカルのみです。',
    'journey.searchEnableTitle': '座標へ移動',
    'journey.searchEnableAction': 'ツールを開く',
    'journey.searchDisableAction': '隠す',
    'journey.searchDisabledPrivacy': '貼り付けた座標や地図リンクで地図を移動するローカル専用ツールです。ネットワークリクエストは送信しません。',
    'journey.searchInvalid': '位置を読み取れませんでした。37.5665, 126.9780 のような座標か対応する地図リンクを貼り付けてください。',
  ...
  zh: {
    ...
    'journey.searchPlaceholder': '粘贴坐标或地图链接',
    'journey.searchAction': '前往',
    'journey.searchPrivacy': '可粘贴 37.5665, 126.9780、geo:37.5665,126.9780 或地图链接。此过程完全在本地完成。',
    'journey.searchEnableTitle': '跳转到坐标',
    'journey.searchEnableAction': '打开工具',
    'journey.searchDisableAction': '隐藏',
    'journey.searchDisabledPrivacy': '这是一个仅在本地运行的跳转工具，可根据粘贴的坐标或地图链接定位地图，不会发送网络请求。',
    'journey.searchInvalid': '无法识别这个位置。请粘贴类似 37.5665, 126.9780 的坐标或受支持的地图链接。',
  ...
  es: {
    ...
    'journey.searchPlaceholder': 'Pega coordenadas o enlace del mapa',
    'journey.searchAction': 'Ir',
    'journey.searchPrivacy': 'Pega coordenadas como 37.5665, 126.9780, geo:37.5665,126.9780 o un enlace de mapa. Todo se resuelve en local.',
    ...
    'journey.searchDisabledPrivacy': 'Abre una herramienta local para centrar el mapa desde coordenadas o enlaces pegados. No se envía ninguna solicitud de red.',
    'journey.searchInvalid': 'No se pudo leer esa ubicación. Pega coordenadas como 37.5665, 126.9780 o un enlace de mapa compatible.',
