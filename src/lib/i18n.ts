...
export const translations = {
  en: {
    ...
    'journey.searchPrivacy': 'Type at least 3 characters. Place search uses OpenStreetMap Nominatim.',
  ...
  ko: {
    ...
    'journey.searchPrivacy': '최소 3글자를 입력하세요. 장소 검색은 OpenStreetMap Nominatim을 사용합니다.',
  ...
  ja: {
    ...
    'journey.searchPrivacy': '3文字以上入力してください。場所検索は OpenStreetMap Nominatim を使用します。',
  ...
  zh: {
    ...
    'journey.searchPrivacy': '至少输入 3 个字符。地点搜索使用 OpenStreetMap Nominatim。',
  ...
  es: {
    ...
    'journey.searchPrivacy': 'Escribe al menos 3 caracteres. La búsqueda de lugares usa OpenStreetMap Nominatim.',
