...
export const translations = {
  en: {
    ...
    'journey.searchAction': 'Search',
    'journey.searchPrivacy': 'Type at least 3 characters. Place search uses OpenStreetMap Nominatim only after you enable it.',
    'journey.searchEnableTitle': 'Place search is optional',
    'journey.searchEnableAction': 'Enable search',
    'journey.searchDisableAction': 'Hide',
    'journey.searchDisabledPrivacy': 'Enabling search sends your query to OpenStreetMap Nominatim. Leave it off to keep route planning fully local.',
  ...
  ko: {
    ...
    'journey.searchAction': '검색',
    'journey.searchPrivacy': '최소 3글자를 입력하세요. 장소 검색은 활성화한 뒤에만 OpenStreetMap Nominatim을 사용합니다.',
    'journey.searchEnableTitle': '장소 검색은 선택 사항입니다',
    'journey.searchEnableAction': '검색 켜기',
    'journey.searchDisableAction': '숨기기',
    'journey.searchDisabledPrivacy': '검색을 켜면 입력한 내용이 OpenStreetMap Nominatim으로 전송됩니다. 로컬로만 경로를 만들려면 끄세요.',
  ...
  ja: {
    ...
    'journey.searchAction': '検索',
    'journey.searchPrivacy': '3文字以上入力してください。場所検索は有効化した後にのみ OpenStreetMap Nominatim を使用します。',
    'journey.searchEnableTitle': '場所検索は任意です',
    'journey.searchEnableAction': '検索を有効化',
    'journey.searchDisableAction': '隠す',
    'journey.searchDisabledPrivacy': '検索を有効にすると入力内容が OpenStreetMap Nominatim に送信されます。ローカルだけで経路を作る場合はオフのままにしてください。',
  ...
  zh: {
    ...
    'journey.searchAction': '搜索',
    'journey.searchPrivacy': '至少输入 3 个字符。地点搜索仅会在你启用后使用 OpenStreetMap Nominatim。',
    'journey.searchEnableTitle': '地点搜索是可选的',
    'journey.searchEnableAction': '启用搜索',
    'journey.searchDisableAction': '隐藏',
    'journey.searchDisabledPrivacy': '启用搜索后，你的查询会发送到 OpenStreetMap Nominatim。若想完全本地规划路线，请保持关闭。',
  ...
  es: {
    ...
    'journey.searchAction': 'Buscar',
    'journey.searchPrivacy': 'Escribe al menos 3 caracteres. La búsqueda de lugares solo usa OpenStreetMap Nominatim después de activarla.',
    'journey.searchEnableTitle': 'La búsqueda de lugares es opcional',
    'journey.searchEnableAction': 'Activar búsqueda',
    'journey.searchDisableAction': 'Ocultar',
    'journey.searchDisabledPrivacy': 'Al activar la búsqueda, tu consulta se envía a OpenStreetMap Nominatim. Déjala apagada para planear la ruta totalmente en local.',
