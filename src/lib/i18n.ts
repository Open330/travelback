...
export const translations = {
  en: {
    ...
    'fileUpload.formatHint': 'Tip: Google Takeout downloads as ZIP—extract it, then choose the Timeline .json file. Photos and videos are not route files.',
  ...
  ko: {
    ...
    'fileUpload.formatHint': '도움말: Google Takeout은 ZIP으로 내려받습니다. 먼저 압축을 풀고 Timeline .json 파일을 선택하세요. 사진과 동영상은 경로 파일이 아닙니다.',
  ...
  ja: {
    ...
    'fileUpload.formatHint': 'ヒント: Google Takeout は ZIP でダウンロードされます。先に展開して Timeline .json ファイルを選んでください。写真や動画はルートファイルではありません。',
  ...
  zh: {
    ...
    'fileUpload.formatHint': '提示：Google Takeout 会下载 ZIP。请先解压，然后选择 Timeline .json 文件。照片和视频不是路线文件。',
  ...
  es: {
    ...
    'fileUpload.formatHint': 'Consejo: Google Takeout se descarga como ZIP. Extráelo primero y elige el archivo Timeline .json. Las fotos y videos no son archivos de ruta.',
